...
# Reprocess all sentences from brown
...
# Calculate the chi-square for EACH sentence. Use sapply for this. 

chi_squared_values = sapply(new_sentences, function(sentence){
  calculate_chi_squared(new_sentences, letter_frequencies)
})
