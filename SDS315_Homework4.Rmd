...
# Now let's generate more sentences to see the kind of distribution we would get. 
num_sentences = 10
num_simulations = 10000
expected_distribution = letter_frequencies

chi2_sim = do(num_simulations)*{
  simulated_counts = rmultinom(1, num_sentences, expected_distribution)
  this_chi2 = chi_squared_statistic(simulated_counts, num_sentences*expected_distribution)
  c(chi2 = this_chi2) # return a vector with names and values
}
...
#Pick a sentence
example_sentence = new_sentences[1]
example_sentence

#Count the occurrences
observed_counts = table(factor(strsplit(example_sentence, "")[[1]], levels = letter_frequencies$Letter))
